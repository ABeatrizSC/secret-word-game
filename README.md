...
<div align="center"> 
  <h1>Projeto Secret Word Game</h1>
...
<ul style="display: flex; flex-direction: column; gap: 15px">
  ...
  <li>O campo de input do jogo foi validado utilizando RegEx e há também verificação para impedir a entrada de uma letra que já foi utilizada;</li>
  <li>A partir deste projeto, pude treinar a manipulação dos conceitos fundamentais do ReactJS: Props, states e components.</li>
</ul>

<h2 name="deploy">🔗Deploy</h2>
<p>Acesse a visualização completa do Projeto Secret Word Game <a href="https://secret-word-game-three.vercel.app/" target="_blank"> aqui</a>.</p>
...
<code>git clone https://github.com/ABeatrizSC/secret-word-game.git</code> 
<br>
<br>
<code>cd secret-word-game</code>
